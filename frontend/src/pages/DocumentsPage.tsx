        ...
        <div className="space-y-6">
          ...
          {selectedType === 'OTHER' && (
            <input
              ...
              className="w-full rounded-xl border border-legally-navy/15 bg-white px-4 py-3 text-sm"
            />
          )}
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <input
              ...
              className="rounded-xl border border-legally-navy/15 bg-white px-4 py-3 text-sm"
            />
            <input
